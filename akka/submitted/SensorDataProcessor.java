...
public class SensorDataProcessor {
    ...
    public static void main(String[] args) {
        ...
        // Tell sensor the ref to the dispatcher
        for (ActorRef r : sensors) {
            r.tell(new ConfigurationMessage(dispatcher), ActorRef.noSender());
        }
        ...
        sensors.get(0).tell(new ConfigurationMessage(dispatcher), ActorRef.noSender());
